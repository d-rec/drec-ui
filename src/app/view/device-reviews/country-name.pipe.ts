...
const ALPHA3_TO_ALPHA2: Record<string, string> = {
  ...
  NIU:'NU',NLD:'NL',NOR:'NO',NPL:'NP',NRU:'NR',NZL:'NZ',OMN:'OM',PAK:'PK',
  PAN:'PA',PER:'PE',PHL:'PH',PLW:'PW',PNG:'PG',POL:'PL',PRK:'KP',PRT:'PT',
  PRY:'PY',PSE:'PS',QAT:'QA',ROU:'RO',RUS:'RU',RWA:'RW',SAU:'SA',SDN:'SD',
  ...
  USA:'US',UZB:'UZ',VCT:'VC',VEN:'VE',VNM:'VN',VUT:'VU',WSM:'WS',YEM:'YE',
...
export class CountryNamePipe implements PipeTransform {
  transform(code: string): string {
    ...
    try { return displayNames.of(alpha2) ?? code; }
    catch { return code; }
  }
}
