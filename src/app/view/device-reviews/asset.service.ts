...
export interface OpenPicture {
  ...
  enableOcr: boolean;
  /** Monotonic stacking order — each new picture gets a higher value so it opens on top. */
  zOrder: number;
}
...
export class AssetService {
  ...
  viewPicture(url: string | null, enableOcr = false): void {
    ...
    // If the same URL is already open, just bring it to the front rather than duplicating.
