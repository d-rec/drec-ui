...
export class EditDeviceComponent implements OnInit {
  ...
  DisplayList() {
    this.authService.GetMethod('countrycode/list').subscribe((data1) => {
  ...
  DisplayfuelList() {
    this.authService.GetMethod('device/fuel-type').subscribe((data3) => {
  ...
  DisplaytypeList() {
    this.authService.GetMethod('device/device-type').subscribe((data4) => {
      // display list in the console
