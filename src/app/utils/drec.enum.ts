...
export enum DocumentType {
  ...
  SF_02C = 'SF_02C', // SF-02c — the I-REC Owner's Declaration letter (OC# field 46)
  PROOF_OF_OWNERSHIP = 'PROOF_OF_OWNERSHIP', // Proof of Ownership: deed / lease / PPA / purchase contract (OC# field 47)
