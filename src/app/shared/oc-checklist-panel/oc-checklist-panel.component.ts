...
const OC_ROWS: OcRow[] = [
  ...
  { n: 2, item: 'Address', compare: '', field: 'address' },
  {
    n: 3,
    item: 'State/Province',
    compare: 'Cross check with: coordinates',
    field: 'stateProvince',
  },
  ...
  },
  {
    n: 6,
    item: 'Latitude',
    compare: 'Cross check with: site photos',
    field: 'latitude',
  },
  {
    n: 7,
  ...
  {
    n: 11,
    item: 'Requested Effective Registration Date',
    compare: '',
    field: 'requestedEffectiveRegDate',
  },
  {
    n: 12,
    item: 'Default Evident Account Code',
    compare: '',
  ...
  },
  {
    ...
    compare: 'Cross check with: SLD',
    field: 'auxiliaryEnergySourceDetails',
  },
  {
    n: 26,
